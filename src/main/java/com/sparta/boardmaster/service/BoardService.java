package com.sparta.boardmaster.service;

import com.sparta.boardmaster.dto.*;
import com.sparta.boardmaster.entity.Board;
import com.sparta.boardmaster.repository.BoardRepository;
...
public class BoardService {
    ...
    public BoardDetailResponseDto getBoard(Long boardId) {
        Board board = boardRepository.findById(boardId).orElseThrow(() -> new NullPointerException("ㅈㅅ 그런 보드 없엉!"));
    ...
    public UpdateBoardTitleResponseDto updateBoardTitle(Long boardId, UpdateBoardTitleRequestDto updateBoardTitleRequestDto) {
        ...
        return new UpdateBoardTitleResponseDto( board.getId(), board.getTitle(), board.getContents() );
    }
    ...
    public UpdateBoardContentsResponseDto updateBoardContents(Long boardId, UpdateBoardContentsRequestDto updateBoardContentsRequestDto) {
        ...
        return new UpdateBoardContentsResponseDto( board.getId(), board.getTitle(), board.getContents());
    }
